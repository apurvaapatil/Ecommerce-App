<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/Navigation_bar.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="E_Commerce_Main.Shop.WebForm5" %>
    ...
    <div class="container-fluid" >
        ...
        <div class="row justify-content-center" >
            <nav aria-label="breadcrumb" >
                ...
                <li class="breadcrumb-item"><a href="bed_home.aspx" style="color: #FF9999">Beds</a></li>
                <li class="breadcrumb-item"><a href="#" style="color: #FF9999">Justina Blakeney Ara Bed</a></li>
                </ol>
            </nav>
        </div>
        <br />
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="center-block">
                    ...
                    <asp:Image ID="img_bed" runat="server" />
                </div>
            </div>

            <div class="col-md-4">
                <div class="center-block-5">
                    <asp:Label ID="lbl_name" runat="server" Font-Size="X-Large" Width="450" Text="" ForeColor="#2e3951 "></asp:Label>
                    <br /> 
                    <asp:Label ID="lbl_id" runat="server" Font-Size="Small" Width="450" Text="" ForeColor="#999999"></asp:Label>
                    <asp:TextBox ID="txt_id" runat="server" Text="" Visible="false"></asp:TextBox>
