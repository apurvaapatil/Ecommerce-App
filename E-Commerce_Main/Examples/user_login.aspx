<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_login.aspx.cs" Inherits="E_Commerce_Main.max" %>
                ...
                <form class="needs-validation">
                   ...
                   <div class="col-md-12">
                       ...
                       <div class="col-md-6 mb-6">
                           <div class="row">
                            <asp:Button  runat="server" onClick="Login" class="btn btn-primary btn-lg btn-block" Text="Login"></asp:Button>
                           <asp:Button runat="server" OnClick="Clears" class="btn btn-primary btn-lg btn-block" Text="Clear"></asp:Button>
